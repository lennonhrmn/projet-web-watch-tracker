        ...
        <nav className="w-full top-0 fixed z-40">
            <div className={`
                ...
                <div className="
                    ...
                    <select id="categorySelect" className="bg-transparent cursor-pointer hover:text-gray-300 translation"
                ...
                <div className="flex flex-row ml-auto gap-7 ietms-center">
