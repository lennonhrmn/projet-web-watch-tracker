...
const DropdownList = ({ episodes, onSelectEpisode, savedEpisodes }: { episodes: number, onSelectEpisode: (episode: number | null) => void, savedEpisodes: Set<number> }) => {
    ...
    return (
        <div className="h-5 w-28 mt-2.5 rounded-md">
            <select onChange={handleChange} className="bg-transparent w-28">
