...
const WatchCard: React.FC<WatchCardProps> = ({ data, type }) => {
  ...
  return (
    <div className="group bg-zinc-900 col-span relative rounded-md w-40 h-38" onClick={handleCardClick}>
      ...
      <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 scale-0 group-hover:scale-110 group-hover:translate-y-[-4vw] group-hover:opacity-100 ">
        <img src={data.coverImage.large} alt={data.title.english} className="cursor-pointer object-contain transition duration shadow-xl rounded-t-md w-40 h-38 "/>
